...
def build_report(sheet1, sources, meta, workflow_name):
    ...
    status_counts, ats_count, fresh_count, discovered_count = source_counts(sources)

    rows = []
    rows.append(["Overview", "Report generated", stamp, "Asia/Kolkata time"])
    rows.append(["Overview", "Workflow", workflow_name, "Generated by V4.4.2"])
